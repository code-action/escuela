                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('alm_codigo') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('alm_codigo') ? ' is-invalid' : '' }}" name="alm_codigo" id="alm_codigo" type="text" placeholder="{{ __('código') }}" value="{{ old('alm_codigo') }}"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('alm_nombre') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('alm_nombre') ? ' is-invalid' : '' }}" name="alm_nombre" id="alm_nombre" type="text" placeholder="{{ __('nombre') }}" value="{{ old('alm_nombre') }}"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('alm_edad') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('alm_edad') ? ' is-invalid' : '' }}" name="alm_edad" id="alm_edad" type="number" placeholder="{{ __('edad') }}" value="{{ old('alm_edad') }}" min="1" pattern="^[0-9]+"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('alm_observacion') ? ' has-danger' : '' }}">
                                        <textarea maxlength="99" cols="30" rows="3" class="form-control" id="alm_observacion" name="alm_observacion" type="text" placeholder="{{ __('observación') }}"aria-required="true">{{ old('alm_observacion') }}</textarea>
